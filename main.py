...
paths.append(os.path.join(os.path.abspath(root_dir), 'twoDtoOneD'))
paths.append(os.path.join(os.path.abspath(root_dir), 'base'))
paths.append(os.path.join(os.path.abspath(root_dir), 'science'))
paths.append(os.path.join(os.path.abspath(root_dir), 'cifb'))
paths.append(os.path.join(os.path.abspath(root_dir), 'bdase'))
paths.append(os.path.join(os.path.abspath(root_dir), 'res'))
paths.append(os.path.join(os.path.abspath(root_dir), 'coords'))
paths.append(os.path.join(os.path.abspath(root_dir), 'GUI_widegts'))
