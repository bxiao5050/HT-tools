 ...
 */
public class ChannelPermissTransaction extends TransactionPermiss {
    ...
    public ExcuteModel Permiss(DataViewCache dataViewCache) {
        Collection<UserPermissInfo> userPermissInfoCollection = CollectionUtil.filter(getPermissInfoList(), new UserPermissInfoEditor(Consts.PermissKey.OAS_CHANNEL));
        ...
        params.add(new DBParam(DBParam.STRING_PARAM, "premissKey", Consts.PermissKey.OAS_CHANNEL));
        ...
        ExcuteModel excuteModel = new ExcuteModel(dataViewCache.getCache(Consts.DataViews.permissGetGameChannels), getGameId(), params);
