 ...
 */
@DataChannel(handlers = {0,1})
public class GetChannel implements com.dataprovider.core.interfaces.DataChannel {
    ...
    public GetChannel(){
        DataChannel metaData = GetChannel.class.getAnnotation(DataChannel.class);
