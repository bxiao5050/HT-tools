 ...
 */
'use strict';
app.controller('oas5MinDataNoPayController', ['$rootScope', '$scope', '$http', '$timeout', '$q', 'toaster','$params', function ($rootScope, $scope, $http, $timeout, $q, toaster,$params) {
    ...
    function getFiveMinRechargeData(){
        $http({
            url: 'api/oas/nopay/5min-recharge',
            method: 'GET',
            params: curParams
        }).success(function (data, header, config, status) {
            if(data.code ==0){
    ...
    function exportFiveMinModule(url)
    {
        ...
        $http({
            url: url,//'/api/oas/export/nopay/5min',
            method: 'GET',
            params: curParams
        }).success(function (data, header, config, status) {
            if(data.code ==0){
    ...
    $scope.export=function(type)
    {
        switch (type){
            ...
            case '2':exportFiveMinModule('api/oas/export/5min-recharge');break
