...
'use strict';
app.controller('overSeasNewUserRegIncomeRateController', ['$rootScope', '$scope', '$http', '$timeout', '$q', 'toaster', '$params', function ($rootScope, $scope, $http, $timeout, $q, toaster, $params) {
    ...
    function getData() {
        $http({
            url: '/api/overSeas/newUserRegIncomeRate',
            method: 'GET',
            params: curParams
    ...
    function exportData() {
        // $http({
        //     url: 'api/overSeas/export/newUserRegIncomeRate',
        //     method: 'GET',
        //     params: curParams
        // }).success(function (data, header, config, status) {
        //     if (data.code == 0) {
