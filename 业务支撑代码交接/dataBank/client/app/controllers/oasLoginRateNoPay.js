...
'use strict';
app.controller('oasLoginRateNoPayController', ['$rootScope', '$scope', '$http', '$timeout', '$q', 'toaster', '$params', function ($rootScope, $scope, $http, $timeout, $q, toaster, $params) {
    ...
    function exportData() {
        $http({
            url: '/api/oas/export/nopay/loginrate',
            method: 'GET',
            params: curParams
        }).success(function (data, header, config, status) {
            if(data.code ==0){
