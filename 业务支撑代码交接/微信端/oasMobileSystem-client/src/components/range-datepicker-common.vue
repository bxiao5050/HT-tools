    ...
    watch: {
      ...
      datetype: function (newVal, oldVal) {
        switch (this.datetype) {
          case 1:
            this.startTime.time = window.moment().add(-7, "days").format('YYYY-MM-DD');
          ...
          case 2:
            ...
            this.endTime.time = window.moment().add(-1, "days").days(0).format('YYYY-MM-DD');
            break;
          case 3:
            this.startTime.time = window.moment().add(-1, "month").date(1).format('YYYY-MM-DD');
            this.endTime.time = window.moment().date(1).add(-1, "days").format('YYYY-MM-DD');
            break;
        }
      }
    },
