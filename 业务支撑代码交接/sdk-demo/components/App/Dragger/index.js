...
export default class Dragger extends React.Component {
    ...
    onDragEnd(event) {
        var len = document.getElementsByTagName("html")[0].style.fontSize.split("px")[0];
        //add here
        ...
        this.props.onDrag(event, this.state.x, this.state.y);
    ...
    componentDidMount() {
        ...
        */
        if (typeof this.props.style.x === 'number' &&
            typeof this.props.style.y === 'number') {
            this.setState({
