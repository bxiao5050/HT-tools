...
class RangeDrag():
    def __init__(self, master, color = 'blue', ax = None):
        ...
        self.rect1 = ax.bar(startPos, ymax,  color = 'blue', width = self.width, alpha = 0.6)[0]
        self.rect2 = ax.bar(startPos + self.width*5, ymax,  color = 'blue', width = self.width, alpha = 0.6)[0]
